...
extension Font {
    ...
    static let uiTitle2 = Font.custom("Manrope-Bold",
    ...
    static let uiHeadline = Font.custom("Manrope-Semibold",
    ...
    static let uiCaption1 = Font.custom("Manrope-Regular",
                                        size: UIFont.preferredFont(forTextStyle: .caption1).pointSize)
    static let uiCaption2 = Font.custom("Manrope-Regular",
